            ...
            <div class="container">
                <form action="/" method="get">
                    ...
                    <div class="card-header bg-white rounded-3 mt-3">
                        ...
                        <div class="row">
                            <div class="col">
                                {{__('message.title')}}: <strong>{{$responses[0]->survey->title}}</strong><br>
                                {{__('message.description')}}: <strong>{{$responses[0]->survey->description}}</strong><br>
                                {{__('message.points')}}: <strong>{{$voto}}/{{$valoreTotale}}</strong>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
